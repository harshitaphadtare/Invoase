    ...
    <div>
      ...
      <div className="flex justify-between mx-5 md:mx-12">
        ...
        <div
          ...
          className="mt-5 flex justify-center items-center gap-2 bg-[#38A37F] px-4 py-2 rounded-lg shadow-md transition-all duration-300 hover:bg-[#2C8565] hover:scale-105 active:scale-100 cursor-pointer"
        >
